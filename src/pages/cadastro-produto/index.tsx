  ...
  return (
    <>
      ...
      <div className="login-bg min-h-screen">
        {/* Header */}
        <header className="bg-gradient-to-r from-red-600 to-red-700 text-white p-4 shadow-lg sticky top-0 z-50">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 max-w-4xl mx-auto">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {usuarioLogado && (
                  <p className="text-xs text-red-200">🏪 {usuarioLogado.nome_estabelecimento}</p>
                )}
              </div>
            </div>
            <button
              onClick={() => router.push('/estabelecimento')}
              className="bg-white hover:bg-gray-100 text-red-600 font-medium py-2 px-4 rounded-lg transition-all text-sm w-full sm:w-auto text-center shadow-lg"
            >
              ← Voltar ao Painel
            </button>
          </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="R$ 0,00"
                      className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-red-200 focus:border-red-500 focus:outline-none bg-white text-gray-900 placeholder-gray-400 placeholder:font-normal font-black text-xl transition-all"
                    />
                  </div>
                </div>
